...
module.exports = (function(){
    ...
    const getTaskDefination = async (provider) => {
        return {
            "sonarcloud": {name: process.env.TASK_DEFINITION_SONAR, container: process.env.CONTAINER_SONAR},
            "brearcloud": {name: process.env.TASK_DEFINITION_BREARER, container: process.env.CONTAINER_BEARER},
    ...
    class AWSECSClient{
        ...
        async executeTask(project){
            ...
            await _ecsClient.send(new RunTaskCommand({
                ...
                taskDefinition: task.name, // scanner task definition name in aws
