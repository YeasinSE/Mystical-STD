...
Sonar infrastructure is a container thats include all required tools for processing scan operation on  project and send report to sonar cloud server. Are you confirm enabled kafka server.
